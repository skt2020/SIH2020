...
export default (function () {
  ...
  if (lineChartBox) {
    ...
    var d= new Date();
    var contime=d.getHours()+":"+d.getMinutes()+":"+d.getSeconds();
    var contime1=d.getHours()+":"+d.getMinutes()+":"+d.getSeconds()-1;
    var contime2=d.getHours()+":"+d.getMinutes()+":"+d.getSeconds()-2;
    var contime3=d.getHours()+":"+d.getMinutes()+":"+d.getSeconds()-3;
    var contime4=d.getHours()+":"+d.getMinutes()+":"+d.getSeconds()-4;
    var contime5=d.getHours()+":"+d.getMinutes()+":"+d.getSeconds()-5;
    var contime6=d.getHours()+":"+d.getMinutes()+":"+d.getSeconds()-6;
   
    new Chart(lineCtx, {
      type: 'line',
      data: {
        labels: [contime6,contime5 , contime4, contime3, contime2, contime1, contime],
        datasets: [{
          label                : 'Series A',
